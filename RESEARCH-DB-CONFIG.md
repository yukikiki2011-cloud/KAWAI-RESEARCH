...
## 自動更新スケジュール（v3.0 再構築版 2026-04-17）

### 実行スケジュール（JST）— 全メンバー共通・1日3回

| 時刻 | 内容 | 対象 |
|------|------|------|
| **10:00** | 🔴 **朝スキャン**: 前夜〜午前中の全メンバー新着投稿を収集 | 全メンバー |
| **15:00** | 🔴 **昼スキャン**: 午前〜午後の全メンバー新着投稿を収集 | 全メンバー |
| **23:00** | 🔴 **夜間バッチ**: 1日の総括リサーチ + Claude Code辞典更新 | 全メンバー |
